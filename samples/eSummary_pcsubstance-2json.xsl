...
<x:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <x:template match="SynonymList | CompoundIDList | MeSHHeadingList | AssaySourceNameList | SourceCategoryList | PharmActionList | MeSHTermList | SourceNameList | CommentList">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
