...
<xsl:choose>
   ...
   <xsl:template match="ChapterID | PubDate | Navigation | Book | RID | Title | ID | Parents | AccessionID | ChapterAccessionID | BookInfo | RType | BookAccessionID | Text | @uid | @status">
      <xsl:param name="context" select="&#34;unknown&#34;"/>
