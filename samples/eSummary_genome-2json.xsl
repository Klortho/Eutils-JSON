...
<x:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <x:template match="Create_Date | Organism_Kingdom | Organism_Group | Organism_Subgroup | Options | Organism_Name | @uid | @db | @status | @weight | @term">
   ...
   <x:template match="AssemblyID | ProjectID | Defline | Project_Accession | Assembly_Name | Assembly_Accession | Status">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
      <x:param name="trailing-comma" select="position() != last()"/>
