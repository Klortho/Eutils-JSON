...
<x:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <x:template match="MedAbbr | IsoAbbr | Country | Publisher | PublicationEndYear | NlmId | ContinuationNotes | Title | string | Language | PublicationStartYear | eISSN | pISSN | @uid | @status">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
