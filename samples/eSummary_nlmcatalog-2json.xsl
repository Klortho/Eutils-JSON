...
<x:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <x:template match="TitleOther | ISSNInfo | AuthorInfo | ResourceInfo | PublicationInfo | TitleMain">
   ...
   <x:template match="ISSNList | TitleMainList | TitleOtherList | AuthorList | PublicationInfoList | BroadHeading | ResourceInfoList">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
      <x:param name="trailing-comma" select="position() != last()"/>
