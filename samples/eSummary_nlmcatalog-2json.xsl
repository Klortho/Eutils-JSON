...
<xsl:choose>
   ...
   <xsl:template match="ISSNList | TitleMainList | TitleOtherList | AuthorList | PublicationInfoList | BroadHeading | ResourceInfoList">
      <xsl:param name="context" select="&#34;unknown&#34;"/>
