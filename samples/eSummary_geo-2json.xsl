...
<xsl:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <xsl:template match="summary | GBACC | UGName | GDS | VMIN | VMAX | taxon | SPOTID | gi | outliers | GSM_L | title | geneName | gdsType | PTACC | idref | SUB_SAMP_L | valType | SUB_TYPES_L | SAGEmap | EVALUE | cloneID | ORF | nucDesc | abscalls_chain | GSE | taxid_L | ERANK | geneDesc | UGDesc | alias | GPL | @uid | @status">
