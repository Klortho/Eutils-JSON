...
<x:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <x:template match="SiteDescriptions">
   ...
   <x:template match="Accession | Organism | PubDate | EntrezDate | Title | string | Abstract | Database | Subtitle | @uid | @status">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
   ...
   <x:template match="LivePssmID | NumberSites | PssmLength | Status | StructureRepresentative">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
