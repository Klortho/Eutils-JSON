...
<x:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <x:template match="tag | SearchTerm | Path | SrcDb | EntrezDatabase | GenCollAssemblyName | GpipeBuild | algorithm | options | EntrezQuery | SeqStrategy | Title | WgsProject | url | TotalLength | Description | LastUpdated | SeqType | Name | @uid | @status">
   ...
   <x:template match="Perc25 | MaxLength | NumSequences | Perc50 | N50 | Taxid | Perc75 | pid">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
   ...
   <x:template match="Project | Term | SourceDbData | ProjectData | TermData | OtherUrlData | SourceDb | OtherUrl | SequenceType | Masking">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
   ...
   <x:template match="SequenceTypeData | MaskingData | DocumentSummarySet">
      <x:param name="indent" select="&#34;&#34;"/>
      <x:param name="context" select="&#34;unknown&#34;"/>
