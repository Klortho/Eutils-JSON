...
<xsl:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <xsl:template match="DS_HeadingMappedToList | DS_PaList | DS_Subheading | DS_PreviousIndexing | DS_MeshTerms | DS_PaPx | DS_SeeRelated | DS_IdxLinks | Children">
   ...
   <xsl:template match="Parent | TreeNum | DS_RevisionDate | DS_ScopeNote | string | DS_HeadingMappedTo | DS_YearIntroduced | DS_EntryDate | DS_RegistryNumber | @uid | @status">
      <xsl:param name="context" select="&#34;unknown&#34;"/>
