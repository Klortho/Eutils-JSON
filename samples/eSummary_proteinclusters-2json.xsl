...
<xsl:stylesheet xmlns:np="http://ncbi.gov/portal/XSLT/namespace"
   ...
   <xsl:template match="ModDate | EC | COG | COGgroup | Comment | Gene | Definition | CreateDate | HAMAP | Source | CommonTaxonomy | GeneSynonym | ACCN | Pmids | KO | @uid | @status">
...
<xsl:choose>
   ...
   <xsl:template match="Total_Publications | Total_genera | Total_dups | AverageLength | Paralogs | Total_Prots | Domains">
      <xsl:param name="context" select="&#34;unknown&#34;"/>
