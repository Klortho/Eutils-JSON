...
<xsl:choose>
   ...
   <xsl:template match="SynonymList | SubstanceIDList | MeSHHeadingList | AssaySourceNameList | SourceIDList | SourceCategoryList | PharmActionList | MeSHTermList | SourceNameList | CommentList">
      <xsl:param name="context" select="&#34;unknown&#34;"/>
